...
//			System.out.println("Here are the Company Coupons: "+companyCoupons);

		// Check companyCoupons only if array isn't Empty
		if (companyCoupons != null) {
			for (Coupon c : companyCoupons) {// Checking if the same company already has coupon with the same title
	...
	public void updateCoupon(Coupon coupon) throws Exception {
		...
		// Creating a Coupon with only the correct updated Values in order to send to
		// updateCoupon Method
