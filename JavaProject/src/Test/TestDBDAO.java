...
public class TestDBDAO {
	...
	public static void testCompaniesDBDAO() throws Exception {
		...
		// ------------------Testing isCompanyExists method with:
		// "myCompanyEmail@email.com", "myPassword" "--------------------------------
		...
		// ------------------Updating a Company with
		// companyUpdated--------------------------------
		// Create an instance of Company with updated values to insert into
		// "UpdateCompany"
		int companyUpdatedID = 5;
		Company companyUpdated = new Company(companyUpdatedID, "myCompanyUpdated", "myCompanyUpdated@email.com",
				"myPasswordUpdated", null);
		...
		// ------------------Testing get all Companies with
		// getAllCompanies--------------------------------
		...
		// ------------------Testing getCompanyID--------------------------------
		String email = "myCompanyUpdated@email.com";
		String password = "myPasswordUpdated";

		System.out.println("Testing getCompanyID with email: " + email + " and password: " + password);
		System.out.println("getCompanyID is: " + companiesDBDAO.getCompanyID(email, password));
		System.out.println("Tested getCompanyID with email: " + email + " and password: " + password);
	...
	public static void testCustomersDBDAO() throws Exception {
		...
		for (int i = 1; i <= 10; i++) {
			...
			Customer myCustomer = new Customer(customerName, "myLastName", "myCustomerEmail@email.com", "myPassword",
					null);
		...
		// ------------------Testing isCustomerExists method with:
		// "myCustomerEmail@email.com", "myPassword" "--------------------------------
		...
		// ------------------Updating a Customer with
		// myCustomerUpdated--------------------------------
		// Create an instance of Customer with updated values to insert into
		// "UpdateCustomer"
		int customerUpdatedID = 5;
		Customer myCustomerUpdated = new Customer(customerUpdatedID, "myCustomerUpdated", "lastNameUpdated",
				"myCustomerUpdated@email.com", "myPasswordUpdated", null);
		...
		// ------------------Testing get all Customers with
		// getAllCustomers--------------------------------
		...
		String email = "myCustomerUpdated@email.com";
		String password = "myPasswordUpdated";

		System.out.println("Testing getCustomerID with email: " + email + " and password: " + password);
		System.out.println("GetCustomerID is: " + myCustomersDBDAO.getCustomerID(email, password));
		System.out.println("Tested getCustomerID with email: " + email + " and password: " + password);
	...
	public static void testCouponsDBDAO() throws Exception {
		...
		for (int i = 1; i <= 10; i++) {
			...
			Coupon coupon = new Coupon(1, Category.Amusement_Park, couponName, "myDescription", new Date(),
		...
		// ------------------Updating a Coupon with
		// updateCoupon--------------------------------
		// Create an instance of Coupon with updated values to insert into
		// "updateCoupon"
		int couponUpdatedID = 4;
		@SuppressWarnings("deprecation")
		Coupon updatedCoupon = new Coupon(couponUpdatedID, 1, Category.Pool, "myUpdatedCoupon", "myDescription",
				new Date(), new Date(119, 1, 20), 100, 200, "myImage");
		...
		int couponTestID = 26;
		System.out.println(
				"Adding Coupon Purchase with Customer ID: " + customerTestID + " and Coupon ID: " + couponTestID);
		couponsDBDAO.addCouponPurchase(customerTestID, couponTestID);
		System.out.println(
				"Added Coupon Purchase with Customer ID: " + customerTestID + " and Coupon ID: " + couponTestID);
	}
